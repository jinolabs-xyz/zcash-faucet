...
SUITE_ORDER="zsnap backup deploy metrics redeploy drift driftreport alerts access dockeruser watchdog repo installops boxreport bringtospec ctazports ctazconfig ctazbroker prune imagemanifest autodeploy zalletrepair zalletrewind zalletclean feedbackdrain"
